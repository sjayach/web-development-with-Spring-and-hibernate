...
<legend class="scheduler-border">New Job</legend><br />

<form:form modelAttribute="newJob">
<table class="table table-striped">
<tr>
<th height="50">Title</th>
<td height="50" width="70%" align="right"><form:input path="title" cssClass="form-control"/> <br /></td>
</tr>
<tr>
<th>Description</th>
...
<tr>
<th>Publish Date</th>
<td><form:input path="publishDate" cssClass="form-control" /></td>
</tr>
<tr>
<th>Close Date</th>
<td><form:input path="closeDate" cssClass="form-control"/></td>
</tr>
<tr>
...
<input type="submit" value="create" name="create" class="btn-success"/> </td>
</tr>
</table>
</form:form>
</fieldset>
