...
public class UserController {
    ...
    public String reviewer(ModelMap models, Authentication auth, @RequestParam(required=false) String term)
    {
    	User u = (User)auth.getPrincipal();
    	if(StringUtils.hasText(term)) {
    	System.out.println("size is " +applicationDao.getAllApplication(u.getId(), term));
    	models.put("allApplication",applicationDao.getAllApplication(u.getId(), term) );
    	}
        return "reviewer";
    }
