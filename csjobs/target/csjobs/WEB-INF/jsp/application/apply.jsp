...
<form:form action="apply.html?jobid=${param.jobid}&${_csrf.parameterName}=${_csrf.token}" modelAttribute="application" enctype="multipart/form-data">
	<h2>${jobTitle}</h2>
	<div class="well">
	...
	<tr>
		...
		<td><input type="file" name="cv1" class="form-control"/></td>
	</tr>
	<tr>
		<th>Teaching Statement</th>
		<td><input type="file" name="ts1" class="form-control"/></td>
	</tr>
	<tr>
		<th>Research Statement</th>
		<td><input type="file" name="rs1" class="form-control"/></td>
	</tr>
	</table>
	</fieldset>
	</div>
